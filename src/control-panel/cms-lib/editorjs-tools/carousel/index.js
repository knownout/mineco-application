...
export default class SimpleCarousel {
    ...
    onUpload(response) {
        if (response.success && response.file) {
            ...
            this._createImage(response.file.url, this.list.lastChild, "", null);
            // (this.list.lastChild).classList.add()

            // console.log(this.list.childNodes[this.list.childNodes.length - 1])
            // this._createImage(response.file.url, this.list.childNodes[this.list.childNodes.length - 1].firstChild, '', this.list.childNodes[this.list.childNodes.length - 1].firstChild.childNodes[1]);
            // this.list.childNodes[this.list.childNodes.length - 1].firstChild.childNodes[2].style.backgroundImage = '';
            // this.list.childNodes[this.list.childNodes.length - 1].firstChild.firstChild.value = response.file.url;
            this.list.childNodes[this.list.childNodes.length - 1].firstChild.classList.add('cdxcarousel-item--empty');
        } else {
