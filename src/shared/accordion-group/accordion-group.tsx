 ...
 * @version 1.0.0
 */
export default class AccordionGroup extends React.PureComponent<AccordionGroup.Properties, AccordionGroup.State>
{
    state: AccordionGroup.State = {
    ...
    render (): React.ReactNode
    {
        ...
        {
            const { icon, children, ...rest } = child.props as AccordionGroup.IItemProps;
     ...
     * @version 0.0.1
     */
    public static readonly Item = (props: AccordionGroup.IItemProps) => <div
 ...
 * @version 1.0.0
 */
function AccordionItem (props: AccordionGroup.IInternalItemProps)
{
